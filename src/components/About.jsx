  ...
  return (
    <section className="texture section" id="about">
      <div className="container about__inner">
        ...
        <div className="about__col about__col--left" data-reveal="clip-h">
        ...
        <img className="about__knife" src={asset('knife.png')} alt="Нож шефа" data-reveal="clip-h" data-parallax="drift" />
        <div className="about__col" data-reveal="clip-h">
